                                          ...
                                          gsize                      *size)
{
    ...
    *size = 0;
    ...
    while (sqlite3_step (stmt) == SQLITE_ROW)
    {
        ...
        g_paste_sqlite_backend_read_special_values (db, sqlite3_column_int64 (stmt, 0), item);
                                     ...
                                     const GPasteItem           *item)
{
    ...
    if (success && found)
    {
        ...
        success = success && g_paste_sqlite_backend_write_special_values (db, item_id, item);
    }
